...
>     
> If you are interested in knowing more, you can read the following article: (insert link to article), this draft standard: https://datatracker.ietf.org/doc/html/draft-foudil-securitytxt-12 or go directly to the free generator at https://securitytxt.org/ to create your security.txt file with information and guidelines for external contact to your security department.  
>   
> Yours sincerely,  
...
>  
>Hvis du er interesserede i at vide mere, kan du læse følgende artikel: (indsæt link til artikel), denne draft standard: https://datatracker.ietf.org/doc/html/draft-foudil-securitytxt-12 eller gå direkte til den gratis generator på https://securitytxt.org/ for at lave jeres security.txt fil med informationer og retningslinjer for ekstern kontakt til jeres sikkerhedsafdeling.  
>  
>Med venlig hilsen  
